    ...
    public partial class frmFieldFilters : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (FieldFilters.Contains(BuiltInFilters.DatabaseBackupJob) || FieldFilters.Contains(BuiltInFilters.FilesManagementJobs) || FieldFilters.Contains(BuiltInFilters.DataTransferCheckList))
                {
        ...
        private void frmFieldFilters_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (FieldFilters.Contains(BuiltInFilters.DataTransferCheckList))
                {
                    ...
                    {
                        transferManager.GetTransferGroups(ref dtTransferGroups);
                        dtTransferGroups.DefaultView.RowFilter = "GroupID <> -1";
                        dtTransferGroups = dtTransferGroups.DefaultView.ToTable();
                    }
                    ...
                    TabPage tp = new TabPage("Data Transfer Filter");
