UPDATE Int_Configuration SET KeyValue = 'telelink' WHERE KeyName = 'SiteSymbol'
...
IF NOT EXISTS (SELECT * FROM Int_Configuration WHERE KeyName = 'WS_UserName' AND OrganizationID = -1)
	INSERT INTO Int_Configuration (ConfigurationID,KeyName,KeyValue,OrganizationID,DataType,Readonly) VALUES (1003,'WS_UserName','2000',-1,1,1)
IF NOT EXISTS (SELECT * FROM Int_Configuration WHERE KeyName = 'WS_Password' AND OrganizationID = -1)
	INSERT INTO Int_Configuration (ConfigurationID,KeyName,KeyValue,OrganizationID,DataType,Readonly) VALUES (1004,'WS_Password','Telelink123-',-1,1,1)
IF NOT EXISTS (SELECT * FROM Int_Configuration WHERE KeyName = 'WS_URL' AND OrganizationID = -1)
	INSERT INTO Int_Configuration (ConfigurationID,KeyName,KeyValue,OrganizationID,DataType,Readonly) VALUES (1005,'WS_URL','https://gw.bisan.com/api/odemo_14',-1,1,1)
IF NOT EXISTS (SELECT * FROM Int_Configuration WHERE KeyName = 'SSL_File' AND OrganizationID = -1)
	INSERT INTO Int_Configuration (ConfigurationID,KeyName,KeyValue,OrganizationID,DataType,Readonly) VALUES (1006,'SSL_File','khaled.pfx',-1,1,1)
IF NOT EXISTS (SELECT * FROM Int_Configuration WHERE KeyName = 'SSL_Key' AND OrganizationID = -1)
	INSERT INTO Int_Configuration (ConfigurationID,KeyName,KeyValue,OrganizationID,DataType,Readonly) VALUES (1007,'SSL_Key','bisan901',-1,1,1)
