    ...
    public class AppBase
    {
        public static void CopySiteFiles(string SiteName, BuildMode Target)
        {
            try
            {
                ...
                string RoadNetIntegrationXMLPath = "";
                ...
                RoadNetIntegrationXMLPath = ApplicationDirectory + string.Format("Connections\\{0}\\integration{1}.xml", SiteName, envParam);
                //To
                ...
                foreach (string buildFile in BuildFiles)
                {
                    ...
                    else if (buildFile == "integration.xml")
                    {
                        if (File.Exists(RoadNetIntegrationXMLPath))
                            File.Copy(RoadNetIntegrationXMLPath, SiteDirectory + "\\integration.xml");
                    }
                    else
                    {
