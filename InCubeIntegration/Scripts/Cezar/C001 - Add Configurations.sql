UPDATE Int_Configuration SET KeyValue = 'cezar' WHERE KeyName = 'SiteSymbol'
...
IF NOT EXISTS (SELECT * FROM Int_Configuration WHERE KeyName = 'WS_UserName' AND OrganizationID = -1)
	INSERT INTO Int_Configuration (ConfigurationID,KeyName,KeyValue,OrganizationID,DataType,Readonly) VALUES (1003,'WS_UserName','incube',-1,1,1)
IF NOT EXISTS (SELECT * FROM Int_Configuration WHERE KeyName = 'WS_Password' AND OrganizationID = -1)
	INSERT INTO Int_Configuration (ConfigurationID,KeyName,KeyValue,OrganizationID,DataType,Readonly) VALUES (1004,'WS_Password','abc@123',-1,1,1)
IF NOT EXISTS (SELECT * FROM Int_Configuration WHERE KeyName = 'WS_URL' AND OrganizationID = -1)
	INSERT INTO Int_Configuration (ConfigurationID,KeyName,KeyValue,OrganizationID,DataType,Readonly) VALUES (1005,'WS_URL','https://gw.bisan.com/api/odemo_12',-1,1,1)
