UPDATE Int_Configuration SET KeyValue = 'khraim' WHERE KeyName = 'SiteSymbol';
...
update Organization set OrganizationCode='Khraim' where Organizationid=1;
if(not exists (select * from PriceQuantityRange where PriceQuantityRangeID=1))
insert into PriceQuantityRange  values(1,0,99999999)
