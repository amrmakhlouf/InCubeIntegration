...
REPLACE( CONVERT(CHAR(10),CAST(T.TRANSACTIONDATE AS TIME)),'':'','''') ''TIME'',E.NationalIDNumber AS CUSTOMER,EL.DESCRIPTION SALESMAN,
...
INNER JOIN [Cubita_test]..InCube_Customer_master CC ON CC.Customer_Code = E.NationalIDNumber
...
CAST(T.TRANSACTIONDATE AS TIME) ,E.NationalIDNumber ,EL.DESCRIPTION ,
W.WAREHOUSECODE ,
...
insert into Cubita_test..im_ret_VDRA (TrxType,
TrxID,
Date,
Time,
Customer,
...
insert into Cubita_test..im_ret_VDRC (TrxType,
TrxID,
LineNum,
MOP,
CurCode,
...
INSERT INTO Cubita_test..im_ret_VDRB(TrxType,
TrxID,
ItemCode,
Unit,
Qty,
...
,CO.CUSTOMERCODE,W.WAREHOUSECODE,E.EMPLOYEECODE,E.NationalIDNumber,EL.DESCRIPTION
...
,CP.PaymentTypeID,CO.CUSTOMERCODE,W.WAREHOUSECODE,E.EMPLOYEECODE,E.NationalIDNumber,EL.DESCRIPTION
open PLOOP 
